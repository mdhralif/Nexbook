    ...
    return (
        <div className="relative lg:hidden flex-shrink-0" ref={searchRef}>
            {!showSearchInput ? (
                ...
                <div className="flex p-2 bg-slate-100 items-center rounded-xl min-w-48">
                    <input
                        type="text"
            ...
            {isOpen && showSearchInput && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto z-50 min-w-48">
                    {isLoading ? (
