    ...
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div className="flex items-center justify-around py-2">
          ...
          <Link href="/clips/autoplay" className={`flex flex-col items-center p-2 ${pathname === '/clips/autoplay' ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'}`}>
            <Image 
              src="/clips.png" 
              alt="Clips" 
              width={24} 
              height={24}
              className={`${pathname === '/clips/autoplay' ? 'brightness-0 saturate-100 hue-rotate-210' : ''}`}
            />
